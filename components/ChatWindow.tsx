...
import { GET_CHAT_MESSAGES, SEND_CHAT_MESSAGE, CHAT_SUBSCRIPTION } from '../graphql/queries.ts';
import { ChatMessage, UserRole, JobStatus } from '../types.ts';
import { Send, X, MessageCircle, User, HardHat, ShieldCheck, Lock, AlertTriangle, Loader2 } from 'lucide-react';
            ...
            <div className="bg-slate-900 text-white p-4 shadow-md">
                ...
                <div className="bg-slate-800/50 rounded-xl p-2.5 flex items-start gap-3 border border-slate-700">
                    ...
                    <p className="text-[10px] text-slate-300 leading-tight">
                        Este chat es auditado por seguridad.
                    </p>
                </div>
            </div>
            ...
            <div className="p-4 bg-white border-t border-slate-100">
                {isChatActive ? (
                    ...
                    <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 text-center">
                        ...
                        <p className="text-xs font-bold text-slate-600">Chat Cerrado</p>
                    </div>
                )}
            </div>
        </div>
